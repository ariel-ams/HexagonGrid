...
- `src/systems/equipment.js`: wearable loadout defaults, player-level availability filtering, reward-choice candidates, reward-choice details, equipped-item lookup, and slot replacement helpers.

...
- The equipment system must be able to create empty and starter loadouts, equip each item into its declared slot, and mirror applied loadouts onto player state.

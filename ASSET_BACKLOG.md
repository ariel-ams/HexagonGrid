...
Migrate the remaining art through small roadmap batches. The normal Wasp, Bat, Trader Beetle, Vine, Double Sting, Glow Pollen, Nectar Cache, and Honey Drop are complete with reversible 2026-08-14 backups and runtime evidence.

1. Common movement/combat: Wasp, Bat, Trader Beetle, Vine, and Double Sting complete.
2. Common utility items: Clean Water and Smoke Puff. Glow Pollen, Nectar Cache, and Honey Drop complete.

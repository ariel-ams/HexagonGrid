...
$source = Join-Path $backupRoot 'assets\bettle-alpha.png'
$target = Join-Path $repositoryRoot 'assets\bettle-alpha.png'
...
Write-Output 'Restored assets/bettle-alpha.png'

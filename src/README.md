...
- `systems/equipment.js`: wearable slot loadout helpers for empty/starter gear, player-level availability, weighted reward choices, bundled reward replacement and slot display details, lookup, effects, and slot replacement.

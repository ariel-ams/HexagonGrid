...
- `node tools/smoke-browser.js` launches the browser, verifies the Test page renders every generated object scenario, starts a run, verifies auto-walk stops on stacked action objects, checks inspect stat chips, and checks market card structure.

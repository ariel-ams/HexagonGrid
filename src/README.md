...
- `systems/equipment.js`: wearable slot loadout helpers for empty/starter gear, player-level availability, weighted reward choices, bundled reward replacement, slot display, and effect summary details, lookup, effects, and slot replacement.

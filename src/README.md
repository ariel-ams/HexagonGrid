...
- `systems/inspect-stats.js`: object effect and terrain metadata that turns item/hazard data into inspect stat chips.
...
- Object/item/hazard stat chips are mapped in `systems/inspect-stats.js`; enemy and route chips are still assembled by `../index.js`.

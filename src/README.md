...
- `systems/equipment.js`: wearable slot loadout helpers for empty/starter gear, localized slot/item copy, player-level availability, reward availability, weighted reward choices, bundled reward replacement, slot display, rarity, reward weight, and effect summary details, lookup, effects, and slot replacement.

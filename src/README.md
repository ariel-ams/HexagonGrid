...
- `systems/inspect-stats.js`: enemy, object effect, and terrain metadata that turns content data into inspect stat chips.
...
- Enemy, object, item, and hazard stat chips are mapped in `systems/inspect-stats.js`; route chips are still assembled by `../index.js`.

...
- If wearable gear changes, keep slot ids unique and equipment ids, rarity, and future effect payloads valid; `smoke-data` treats this as the gear contract until loot is implemented.

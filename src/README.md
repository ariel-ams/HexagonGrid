...
- `systems/equipment.js`: wearable slot loadout helpers for starting gear, lookup, and slot replacement.
...
- If wearable gear changes, keep slot ids unique, provide exactly one starter item per slot, and keep equipment ids, rarity, registered effect payloads, and loadout behavior valid; `smoke-data` treats this as the gear contract until loot is implemented.

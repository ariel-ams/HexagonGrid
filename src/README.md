...
- `systems/equipment.js`: wearable slot loadout helpers for empty/starter gear, player-level availability, weighted reward choices, reward replacement details, lookup, effects, and slot replacement.

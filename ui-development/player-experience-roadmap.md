...
- Equipment loot loop: helmet, jacket, abdomen guard, sting, wings. Starter loadouts now exist, are equipped for new runs, carry level metadata, and can be filtered by player level; next work is loot acquisition and UI choices.

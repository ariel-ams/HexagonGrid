...
- Equipment loot loop: helmet, jacket, abdomen guard, sting, wings. Starter loadouts now exist, are equipped for new runs, and carry level metadata; next work is loot acquisition and UI choices.
